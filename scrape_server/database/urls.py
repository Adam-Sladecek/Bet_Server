...
from database.views import (ConfigView, OpportunityView, PreferedOpportunityView, OpportunityChildrenView, 
                            DeleteOpportunityChildrenView, AddOpportunityChildrenView, EventView, UsedEventView, 
...
urlpatterns = [
    ...
    path('opportunity/children/<int:pk>', DeleteOpportunityChildrenView.as_view(), name='delete_opportunity_children'),
    path('opportunity/children/<int:pk>/add/<int:childid>', AddOpportunityChildrenView.as_view(), name='add_opportunity_children'),
