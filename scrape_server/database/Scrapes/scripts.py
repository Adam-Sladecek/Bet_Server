...
def update_events(events_list: list[EventModel], sport_id: int, sportsbook_id: int):
    ...
    for event_data in events_list:
        if event_data.event_id in existing_events_dict:
            ...
            event_ids_to_delete.append(existing_event.event_id)
    ...
    with transaction.atomic():
        used_event_ids = [event_data.event_id for event_data in events_list if event_data.event_id not in event_ids_to_delete]
